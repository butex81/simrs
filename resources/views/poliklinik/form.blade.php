...
@endif	
			{!! Form::open(array('url'=>'poliklinik/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'poliklinikFormAjax')) !!}
			<div class="col-md-6">
...
$(document).ready(function() { 
	...
	$('input[type="checkbox"],input[type="radio"]').iCheck({
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("poliklinik/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
